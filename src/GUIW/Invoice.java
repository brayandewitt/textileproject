...
public class Invoice extends javax.swing.JFrame {
    ...
    public void setUserData(User user) {
        this.user = user;
        jLabel39.setText(user.getUserUsername());
        jLabel34.setText("Hello " + user.getUserFname() + " " + user.getUserLname());
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ResultSet resultset = MySQL.search("SELECT * FROM `customer` WHERE `mobile`='" + mobile + "'");
                if (resultset.next()) {
                    ...
                    coustomerBean.setFname(fname);
                    coustomerBean.setLname(lname);
                    coustomerBean.setMobile(mobile);
                    coustomerBean.setPoint(points);
                    ...
                    coustomerBean.setFname("None");
                    coustomerBean.setLname("None");
                    coustomerBean.setMobile("None");
                    coustomerBean.setPoint(0);
    ...
    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                ResultSet resultset = MySQL.search("SElECT * FROM `STOCK` INNER JOIN `size`\n"
                        + "ON `stock`.`s_id`=`size`.`s_id`\n"
                        + "INNER JOIN `color`\n"
                ...
                if (resultset.next()) {
                    ...
                    String availability = resultset.getString("available_qty");

                    jLabel9.setText(pid);
                    jLabel17.setText(title);
                    jLabel11.setText(mainCategory);
